...
extend({ TextGeometry })
const Card = ({ QRcode, profileImage, memberRank, joinDate, memberName, textColor, bodyColor, memberId, location, actOfKindness, rotation, showBackSide, backgroundVideo, rankColor }) => {
        ...
        <group scale={1.7} ref={group} dispose={null}>
            <group name="final_for_render_">
                <group name="base_parent_" position={[0, -0.09, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.73}>
                    ...
                    <mesh name="RoundBorder" material-metalness={1} material-roughness={0.2} geometry={nodes.RoundBorder.geometry} material={materials['Material.007']} position={[0.02, 0.089, -0.15]} scale={[0.71, 0.05, 0.71]} />
