...
Command: npx gltfjsx@6.1.4 CARD 2.glb
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/CARD 2.glb')
      ...
      <group name="final_for_render_">
        <group name="base_parent_" position={[0, -0.09, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.73}>
          ...
          <mesh name="profile" geometry={nodes.profile.geometry} material={materials.profile} position={[0.02, 0.05, -0.15]} scale={[0.77, 0.05, 0.77]}>
            <mesh name="cardBody" geometry={nodes.cardBody.geometry} material={materials.body} position={[-0.03, -0.91, 0.28]} scale={[1.51, 12.58, 2.01]}>
              <mesh name="RoundBorder" geometry={nodes.RoundBorder.geometry} material={materials.RoundBorder} position={[0.02, 0.07, -0.14]} scale={[0.62, 0.07, 0.46]} />
            </mesh>
          </mesh>
        </group>
        ...
        <mesh name="Circle" geometry={nodes.Circle.geometry} material={materials['RANK 1']} position={[0, 1.24, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.23} />
      </group>
    </group>
  )
}

useGLTF.preload('/CARD 2.glb')
